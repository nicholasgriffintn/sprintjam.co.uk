import type {
  PolychatStrudelStyle,
  StrudelGenerationComplexity,
} from "@sprintjam/utils";

type StrudelPhase = "lobby" | "voting" | "discussion" | "reveal" | "wrapup";

type StrudelMusicPreset = {
  id: string;
  name: string;
  description: string;
...
} satisfies Record<StrudelPhase, StrudelMusicPreset[]>;
