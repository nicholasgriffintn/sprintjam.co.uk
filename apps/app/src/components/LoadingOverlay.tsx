...
const LoadingOverlay: FC = () => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/10 dark:bg-black/30 backdrop-blur-sm">
      <div className="p-6 bg-white/90 dark:bg-slate-900/90 rounded-2xl shadow-floating border border-slate-200/80 dark:border-white/10 flex flex-col items-center">
