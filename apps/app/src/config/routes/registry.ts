...
import CreateWheelScreen from '@/routes/wheel/CreateWheelScreen';
import JoinWheelScreen from '@/routes/wheel/JoinWheelScreen';
...
export const ROUTES = [
  ...
  },
  {
    ...
    meta: {
      title: `Create Wheel - ${SITE_NAME}`,
      description:
        'Create a new wheel spinner for your team. Randomly select team members for standups, reviews, or any occasion.',
      keywords:
        'wheel spinner, random picker, team selection, name picker, random name',
      ogImage: '/og-image.png',
    },
  },
  {
    ...
    path: '/wheel/join',
    group: 'flow',
    component: JoinWheelScreen,
    meta: {
      title: `Join Wheel - ${SITE_NAME}`,
      description:
        'Join an existing wheel spinner room. Enter your room code to participate in the random selection.',
      keywords: 'join wheel, wheel spinner, random picker, team selection',
      ogImage: '/og-image.png',
    },
  },
  {
