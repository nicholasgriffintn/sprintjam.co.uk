...
Structured Voting is for when a single number is not enough. It shows *why* the work feels big, so the team can address the real risk instead of arguing over a point value.
