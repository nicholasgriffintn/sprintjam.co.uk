...
export function useVoteDistributionControls(roomData: RoomData, stats: RoomStats) {
  ...
  }, [roomData.key, roomData.settings.estimateOptions, roomData.users.length, stats.distribution, stats.totalVotes]);
